...
const proceedToPayment =() =>{
  ...
  window.open(`http://localhost:8089/alipay/pay?orderName=${orderDetails.value.arrivalAirport}&orderId=${orderDetails.value.bookingId}&totalPrice=${orderDetails.value.totalPrice}&orderType=${orderType}`);
}
const update = async () => {
